		...
		<table class='table table-striped' border="1" style="margin-top: 10px;">
			<thead>
				<tr>
                    ...
                    <th><span class="glyphicon glyphicon-calendar"></span>&nbspDate expire</th>
                     <th><span class="glyphicon glyphicon-cog"></span>&nbspProgram</th>
			...
			<?php
					...
					while($row = mysqli_fetch_array($qry)){ ?>	
						<tr>
							...
							<td><a href="admin_paid.php?id=<?php echo $row[1]?>"><button class="btn btn-warning">Edit</button></a>&nbsp
								<a href="deletetran.php?id=<?php echo $row[0]?>"><button class="btn btn-danger id" id="<?php echo $row[0]?>"><span class="glyphicon glyphicon-trash" name ="delete"></span>&nbspDelete</button></td>
				...
				<?php	}
					...
					echo "<b style='color: red;'>There is no transactions right now</b>";
				} 
				?>
		</table>
	</div>
