    ...
    if($num_rows > 0){
        ...
        $sql = "INSERT INTO `members`(`mem_id`, `acc_id`, `firstname`, `middlename`, `lastname`,  `gender`, `payment`, `cellphone`, `birthday`, `remaining`) 
            ...
            if($acc_qry && $mem_qry && $trans_qry ){
                echo "<div class='alert alert-success'><strong>Successfully registered!</strong>, Click here to <a href='index.php'>login</a></div>";
            }
            else{
                echo "Error";
            }
...
<a href="index.php" style="float: right; margin-right: 5px;"><button class="btn btn-warning"><span class="glyphicon glyphicon-log-out"></span>&nbspBack</button></a></b>
<body>
